...
Route::get('/news/{id}/comments', [ComentsController::class, 'getComments']);
Route::post('/news/{id}/comments', [ComentsController::class, 'store']);
...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::delete('/news/{id}', [NewsControllers::class, 'deleteNews']);
    ...
    Route::delete('/comments/{id}', [ComentsController::class, 'destroy']);
